...
Si la condition est vraie on execute le code se trouvant à l'intérieur de la condition, si pas ce code en question sera ignoré et on passera à la suite.
